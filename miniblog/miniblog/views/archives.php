    ...
    <section id="recentpost" class="recentpost">
        ...
        foreach ($billets as $billet) {
            ...
            if (isset($_SESSION['message'])) {
                echo "<p style='color:#FF0000'>{$_SESSION['message']}</p>";
                unset($_SESSION['message']); // on supprime le message après affichage
            }
            echo "<input type='submit' class='button-commentaire' value='Envoyer'></button>
            </form>
            </div>
            </div>";
        }
